...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "quizType")
@JsonSubTypes({
...
public sealed interface QuizQuestionDto permits
                PersistenceQuizQuestionDto, LinguisticQuizQuestionDto, MemoryQuizQuestionDto, AttentionQuizQuestionDto,
                SpacetimeQuizQuestionDto {
        Long questionId();
