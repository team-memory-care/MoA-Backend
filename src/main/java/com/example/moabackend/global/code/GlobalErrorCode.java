...
public enum GlobalErrorCode implements ErrorCode {
    ...
    ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "이미 존재하는 데이터입니다."), // NOTE: 400 -> 409 CONFLICT 권장
    ALREADY_ROLE_SELECTED(HttpStatus.BAD_REQUEST, "이미 역할을 선택했습니다."), // NOTE: 400 -> 409 CONFLICT 권장
